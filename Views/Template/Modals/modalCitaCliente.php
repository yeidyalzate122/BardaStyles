<!-- Modal guardar-->
<div class="modal fade" id="modalFormCitaCliente" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="formCitaCliente" name="formCitaCliente" class="form-horizontal">
        ...
        <div id="clienteid">
          ...
          <div class="form-row">
            <div class="form-group col-md-6">
              ...
              <input class="form-control valid validText" id="listCedula" name="listCedula" type="number" required="" disiable  value="<?= $_SESSION['userData']['numero_documento_cliente']; ?>">
...
<!-- Modal vista -->
<div class="modal fade" id="modalViewCitasCliente" tabindex="-1" role="dialog" aria-hidden="true">
