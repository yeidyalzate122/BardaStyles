    ...
    <section class="login-content ">
      ...
      <div class="login-box">
        ...
        <form class="login-form" name="formLogin" id="formLogin" action="">
          <h3 class="login-head"><i class="fa fa-lg fa-fw fa-user"></i>INICIAR SESIÓN EMPLEADO</h3>
          <div class="form-group">
            <label class="control-label">NÚMERO DE IDENTIDAD</label>
            <input id="txtIdentidad" name="txtIdentidad" class="form-control" type="number" placeholder="ejem: cedula, tarjeta de identidad" autofocus>
          </div>
          <div class="form-group">
