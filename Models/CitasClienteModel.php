...
class CitasClienteModel extends Mysql
{
    ...
    public function selectIdCliente(string $idcliente)
    { //me trae todad las citas de cada cliente


        $this->intIdCliente = $idcliente;
        $sql = "SELECT idcliente FROM cliente where numero_documento_cliente= $this->intIdCliente";
    ...
    public function selectCita(int $idcliente)
    { //me trae todad las citas de cada cliente
        $this->intIdCliente = $idcliente;
        $sql = "SELECT c.idcita, c.fecha, c.idhora, h.descripcion, h.idhora,
            ...
            c.id_estado_cita, ec.id_estado_cita, ec.estado
                 ...
                 where cl.numero_documento_cliente=$this->intIdCliente";
        $request = $this->select_all($sql);
        return $request;
    }

    public function selectCitaCliente(int $idcliente)
    { //me trae todad las citas de cada cliente
        $this->intIdCliente = $idcliente;
        $sql = "SELECT c.idcita, c.fecha, c.idhora, h.descripcion, h.idhora,
            c.total_servicio, c.idcliente,cl.idcliente, cl.numero_documento_cliente,cl.nombre as nombreCli, cl.apellido_uno as apellidoCli,
            ...
            c.id_estado_cita, ec.id_estado_cita, ec.estado, dp.id_detalle_producto,dp.idproducto, dp.idcita,p.nombre  
                 ...
                 where c.idcliente=$this->intIdCliente";
        $request = $this->select_all($sql);
        return $request;
    }
